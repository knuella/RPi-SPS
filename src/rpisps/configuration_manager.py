...
class ConfigurationManager():
    ...
    def extract_payload(self, request):
        ...
        return (operation, targets, collection)


    def handle_request_value(self, operation, targets, collection):
        """
    ...
    def handle_request(self, request):
        ...
        """
        try:
            operation, targets, collection = self.extract_payload(request)
